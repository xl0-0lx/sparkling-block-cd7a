...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/tex2img-1
```

A live public deployment of this template is available at [https://tex2img-1.templates.workers.dev](https://tex2img-1.templates.workers.dev)
